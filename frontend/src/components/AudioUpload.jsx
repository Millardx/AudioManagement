...
import styles from './AudioUpload.module.scss'; // Import the SCSS styling for this component
...
const AudioUpload = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage('Error uploading audio.'); // Show error message if the upload fails
    }
  };
